...
func (rq *RoomQuery) QueryUserInformations() *UserQuery {
...
func (rq *RoomQuery) WithUserInformations(opts ...func(*UserQuery)) *RoomQuery {
	query := &UserQuery{config: rq.config}
	for _, opt := range opts {
		opt(query)
	}
	rq.withUserInformations = query
	return rq
}
...
func (rq *RoomQuery) sqlAll(ctx context.Context) ([]*Room, error) {
	...
	if query := rq.withUserInformations; query != nil {
		...
		query.Where(predicate.User(func(s *sql.Selector) {
			s.Where(sql.InValues(room.UserInformationsColumn, fks...))
		}))
